...
const routes = [{
        ...
        children: [
            { path: 'general',
                loadChildren: () => __webpack_require__.e(/*! import() | general-general-module */ "general-general-module").then(__webpack_require__.bind(null, /*! ./general/general.module */ "./src/app/pages/general/general.module.ts")).then(m => m.GeneralModule)
            }
        ]
    }
];
...
PagesRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function PagesRoutingModule_Factory(t) { return new (t || PagesRoutingModule)(); }, imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)],
